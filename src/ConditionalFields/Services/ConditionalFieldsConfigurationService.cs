...
/// </summary>
public class ConditionalFieldsConfigurationService : IConditionalFieldsConfigurationService
{
    private const string KeyPrefix = "ConditionalFields.PropertyType.";

    private readonly IKeyValueService _keyValueService;
    private readonly ILogger<ConditionalFieldsConfigurationService> _logger;

    public ConditionalFieldsConfigurationService(
        IKeyValueService keyValueService,
        ILogger<ConditionalFieldsConfigurationService> logger)
    {
