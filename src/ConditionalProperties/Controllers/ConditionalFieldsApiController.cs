...
{
    [ApiVersion("1.0")]
    public class ConditionalPropertiesApiController : ConditionalPropertiesApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public ConditionalPropertiesApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
