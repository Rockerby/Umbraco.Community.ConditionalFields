...
namespace ConditionalProperties.Controllers;

/// <summary>
/// API controller for managing conditional field configurations
/// </summary>
[ApiVersion("1.0")]
public class ConditionalPropertiesConfigurationApiController : ConditionalPropertiesApiControllerBase
{
    private readonly IConditionalPropertiesConfigurationService _configurationService;
    private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

    public ConditionalPropertiesConfigurationApiController(
        IConditionalPropertiesConfigurationService configurationService,
